...
{
    internal class Day4Part2 : ISolution
    {
        bool[][] papers;
        ...
        private long RemovePapers()
        {
            bool[][] newPapers = new bool[papers.Length][];
            long count = 0;
            for (int r = 0; r < papers.Length; r++)
            {
                newPapers[r] = new bool[papers[r].Length];
